  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: 900, margin: '2rem auto', padding: '0 1rem' }}>
      <header style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', marginBottom: '0.5rem', color: '#2c3e50' }}>Helping Hands Trust</h1>
      ...
      <section style={{ marginBottom: '2rem', lineHeight: 1.6, color: '#555' }}>
        ...
        <p>
          Helping Hands Trust is dedicated to empowering underprivileged communities through education, healthcare, and sustainable development initiatives.
      ...
      <section style={{ marginBottom: '2rem', lineHeight: 1.6, color: '#555' }}>
        ...
        <ul style={{ paddingLeft: '1.25rem' }}>
          <li>Provide scholarships and educational resources to children in need</li>
          <li>Organize health camps and awareness programs</li>
